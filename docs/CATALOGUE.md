...
| `source_revision` | (set to release commit at catalogue PR time) |
| `wheel_url` | https://github.com/gillesbolland/zorkcore/releases/download/v0.9.1/zorcore_plugin-0.9.1-py3-none-any.whl |
| `sha256` | (compute from Release wheel bytes) |

## Checklist before catalogue PR

1. Repo is **public**
2. Immutable GitHub Release `v0.9.1` (or newer) with the wheel
